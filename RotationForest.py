...
class RotationForest(object):
    ...
    def predict(self, X):
        ...
        # y_pred = mode(ensemble_output, axis=1)[0]   # 按众数输出！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
        ...
        while counter < len(X):
            ...
            counter1 = 0
            while counter1 < dim:
                if ensemble_output[counter][counter1] == 0:
                    sum0 = sum0 + 1
                if ensemble_output[counter][counter1] == 1:
                    sum1 = sum1 + 1
                counter1 = counter1 + 1
            if sum0 > sum1:
                y_pred.append(0)
        ...
        y_pred = np.array(y_pred)  # 转换为np.array
